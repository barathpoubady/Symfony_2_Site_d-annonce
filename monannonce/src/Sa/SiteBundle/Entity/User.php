 ...
 * @ORM\Entity()
 * 
 * @UniqueEntity(fields={"username"},message="Username dÃ©jÃ  utilisÃ© !")
...
class User implements UserInterface,AdvancedUserInterface, Serializable
{
     ...
     *  @Assert\Length(
     *      min = "6",
     *      minMessage = "Votre Username doit faire au moins {{ limit }} caractÃ¨res"
     * )
     */
    private $username;
     ...
     *  @Assert\Length(
     *      min = "6",
     *      minMessage = "Votre Password doit faire au moins {{ limit }} caractÃ¨res"
     * )
     */
    private $password;
