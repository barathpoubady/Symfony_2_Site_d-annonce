 ...
 */
class Role extends \Sa\SiteBundle\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Sa\\SiteBundle\\Entity\\Role' . "\0" . 'id', '' . "\0" . 'Sa\\SiteBundle\\Entity\\Role' . "\0" . 'role', '' . "\0" . 'Sa\\SiteBundle\\Entity\\Role' . "\0" . 'user');
        }
